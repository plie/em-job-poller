# 1Password — Engineering Manager, Credential Governance

- url: https://jobs.ashbyhq.com/1password/e84ee8a7-18ef-4303-a720-9fd582ce0f38
...
A vendor portal login is stored in an employee’s personal vault. The employee leaves the company, but the team still relies on the account. No one has rotated the password, and no administrator knows the credential exists. This gap between the credentials a company uses and the credentials it can see is what Credential Governance is built to close.



Credential Governance gives enterprise administrators a central view of company-owned credentials across employee and shared vaults. It enables them to take ownership of those credentials, control how they’re accessed, and manage that access over time. The product brings visibility and accountability to credentials that have historically been difficult to track.



We’re looking for an Engineering Manager to guide this high-visibility product through launch and into maturity. You’ll lead a team building the governance capabilities that help enterprises secure critical credentials and get more value from 1Password. You’ll also help define how 1Password manages company-owned credentials as organizations and their teams grow.
...
What we're looking for:
 ...
 - Several years of experience managing engineers and leading the development and operation of a production service.

 - A working understanding of web development and backend technologies. You don’t need to write code, but you should be able to engage with complex technical problems, ask thoughtful questions, and help the team make sound decisions.

 - A track record of building a healthy team environment where people feel supported, challenged, and able to do their best work.

 - Experience leading project delivery and maintaining a roadmap that connects near-term execution to longer-term goals.

 - Strong judgment about when to accept short-term friction in service of long-term value, and when to build the smallest solution that will generate the most learning.

 - Experience growing teams and operating services as their scope and complexity increase.

 - Experience managing a remote or distributed team.

 - Good judgment about when and how to use artificial intelligence tools to move faster while maintaining a high quality bar.
...
What you can expect:
 ...
 - Set the team’s strategic direction and connect it to company objectives.

 - Build alignment and accountability around team goals and results.

 - Partner with senior engineers and technical leaders to develop the team’s technical vision.

 - Work with product, design, and other cross-functional partners to define solutions for customers.

 - Scope and plan key deliverables, then guide the team through execution.

 - Set a high quality bar through incremental delivery, clear communication, and continuous feedback.

 - Balance experiments that test product-market fit with investments in durable, maintainable products.

 - Provide technical leadership across the engineering organization.

 - Coach and mentor engineers as they grow their skills and careers.

 - Recruit and retain strong team members in an evolving environment.





USA-based roles only: The annual base salary for this role is between  $190,000 USD and $278,000 USD, plus immediate participation in 1Password's benefits program (health, dental, 401k and many others), utilization of our generous paid time off, an equity grant and, where applicable, participation in our incentive programs.
