...
Location: Waltham, MA (hybrid) 
 ...
 Great developer experience is a major goal for our engineering. At NEXT, we believe that world-class engineering requires a world-class environment. Our Developer Experience (DevEx) team isn't just about managing servers; we are architects of the development lifecycle. As the Team Lead for the Developer Experience Team, you will lead a high-performing team of Backend and DevOps engineers dedicated to redefining the developer journey at NEXT. In this role, you will drive technical excellence, foster the professional growth of your engineers, and serve as a key leader within Platform Engineering. This is a unique opportunity to build and lead a brand-new DevEx team from the ground up, shaping its foundation from day one. You will work in close partnership with a parallel DevEx team in our Israeli site, collaborating to align strategies and deliver a world-class developer experience across the organization.

 What You’ll Do:  

 Execute our strategy for an Agentic SDLC, leveraging AI to automate and enhance the design-to-deployment lifecycle.

 Champion a 'Platform-as-a-Product' mindset, delivering intuitive self-service tools that solve real-world development bottlenecks.

 Partner deeply with R&D stakeholders to ensure our platform capabilities stay perfectly aligned with developer needs and business objectives.

 Lead and mentor a cross-functional team of Backend and DevOps engineers, fostering an environment of continuous learning and growth.

 What We Need:  

 B.Sc. in Computer Science or equivalent.

 At least 3 years of experience as a Backend team lead.

 At least 5 years of experience as a Backend Developer in a fast-paced cloud oriented organization.

 Strategic thinking and ability to prioritize initiatives effectively.

 Excellent communication, collaboration and planning skills.

 Ability to cultivate deep trust and build long-standing, meaningful relationships with stakeholders to drive cross-functional alignment.

 Proven record of initiating, designing, implementing and leading meaningful projects.

 Experience improving development processes and a passion for Developer Experience (DevEx).

 A self-driven leader with a deep curiosity to master and implement AI technologies within the SDLC.

 Technical understanding in CI/CD, K8S and Infrastructure-as-Code.

 Technical understanding in Build tools (Maven/Gradle/nx), testing frameworks, and observability.
